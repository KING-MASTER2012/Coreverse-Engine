...
enum class RenderErrorCode {
    ...
    OutOfMemory,
    DeviceLost,
    ZeroExtent, ///< The surface currently has a 0x0 extent (e.g. a minimized window): nothing can be presented until it
                ///< has a size again — not a failure of the device or the surface.
    Unknown,
};
